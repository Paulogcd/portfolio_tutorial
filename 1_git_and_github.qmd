...
**Git** is a software that allows to manage all the changes done to selected files. It is also called a version management software, or a version control system. 
...
"Commit" means here that the changes will be recorded in the history of changes.
...
Simply put, the terminal allows to textually communicate with your machine, instead of graphically, like it is usually the case nowadays.
