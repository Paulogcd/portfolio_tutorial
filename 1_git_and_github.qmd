...
It's done ! We settled vscode correctly for the next step : using Git and Github.
...
It is a website that takes the concept of git and allows for a remote interaction with your tracked files.
...
The first one is based on the Graphical User Interface (GUI) solution of Github Desktop, an application that offers a simple interface to interact with git and github at the same time. 
It is more simple and quick to setup, especially if you are not familiar or confortable with the second approach : the Command Line Interface (CLI) approach.
This second solution uses the basic git and github solutions. 
It requires more steps, and is a bit harder to setup, but you will develop a deeper understanding of what is going on when you use Git and Github.

::: {.panel-tabset group="method"}
## GitHub Desktop : The Graphical User Interface (GUI)

This section presents the method to use Git and Github via a GUI. 
In order for us to do so, we are going to use Github Desktop. 

### Setup your Github account

The first step is to create a Github account.
You can go [here](https://github.com/) and click on sign up.
Be especially thoughtful of your username, because your website will inlcude it in its url (it will have the format "https://username.github.io").
After having created your account, you should land on a page looking like that : 

![The starting page of Github.](./resources/images/1_9_starting_page_github)

The second step is to create a repository named "username.github.io" replacing the "username" with your actual username.
For example, with the username "fgrpgcd", I create a repository named frpgcd.github.io : 

![Creating a repository with some information.](1_11_create_repo_filled)


### Use GIthub Desktop

The next step is to install Github desktop. 
You then have to open it, and connect yourself to your Github account. 
It will aks you what you want to do, and you will select clone your repository. 
Now, if you make any change in your folder, you will be able to commit the changes. 
Check the Github repository : your local files should be online !
