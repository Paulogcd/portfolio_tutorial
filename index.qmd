...
You would like to have an online portfolio to share your work in research :thinking:, but you do not have much time and are not proefficient in web development :confused: ?
...
| Chapter | Summary |
|---|---|
| [1. Setting up our workflow](1_git_and_github.qmd) | In this chapter, we will learn what Git and GitHub are, and how to use them. This serves to setup the workflow that will be used in the rest of the tutorial. |
| [2. Creating our content with Quarto](2_quarto.qmd) | In this chapter, we will learn to create and modify web content with Quarto. This serves to create the content of our portfolio. |
